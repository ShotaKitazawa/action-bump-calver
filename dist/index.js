...
const calver_1 = __webpack_require__(612);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let currentVersion = core.getInput('current_version');
            const newVersion = new calver_1.Calver(currentVersion).inc().toString();
...
class Calver {
    ...
    inc() {
        const now = new Date();
        if (String(now.getFullYear()).endsWith(this.year) &&
